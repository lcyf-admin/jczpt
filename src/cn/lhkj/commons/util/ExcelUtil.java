...
public class ExcelUtil {
	...
	public static ArrayList<ArrayList<Object>> readExcel(File file,String ends){
		if(file == null){
			return null;
		}
		if(ends != null){
			if(ends.toLowerCase().equals("xlsx")){
				//处理ecxel2007
	...
	public static void main(String[] args) {
		...
		ArrayList<ArrayList<Object>> result = ExcelUtil.readExcel(file,null);
		for(int i = 0 ;i < result.size() ;i++){
			for(int j = 0;j<result.get(i).size(); j++){
