...
/**经过闸机车辆和前置卡口的所有数据信息 */
@Entity(table="CSL_VEHICLE", key="id", partition="monthId")
public class Vehicle {
	...
	/**分类：VehicleShunt表示前置卡口VehicleBrake表示车证合一的闸机*/
	...
	public String getDriverName(){
		if(StringUtil.isNull(userName)) return "-";
		return userName;
	}
	
	public String getDriverIdcard(){
		if(StringUtil.isNull(cardNum)) return "-";
		return cardNum;
	}
