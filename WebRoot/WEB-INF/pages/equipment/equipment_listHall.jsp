...
<script>
	var gridURL = "equipment_ajaxGridOfHall.do";
$(function(){
	$("#equipmentGrid").jqGrid({
		...
		autowidth: true,
	   	colModel: [
            ...
            {name: "HALLNAME",width:"120px",align:"center",sortable:false,label:"安检厅"},
            {name: "REMARK",width:"260px",align:"center",sortable:false,label:"备注"},
	...
	//增加安检厅设备
	function addOfHall(){
	    window.open("equipment_addOfHall.do", "I3");
	}
	...
	function mySearch(){
		...
		var url = "equipment_ajaxGridOfHall.do?inputValue="+inputValue;
		$("#equipmentGrid").jqGrid("setGridParam",{url: url,page:1}).trigger("reloadGrid");//刷新Grid
	}
	
	//编辑设备
	function editEquipment(equipmentId){
		var editUrl = "equipment_editOfHall.do?equipment.id=" + equipmentId;
...
<div class="lk-panel-reasarch">
  ...
  <div class="input-btn">
    <div class="btn-group">
    	<input type="button" onclick="javascript:addOfHall();" class="btn btn-info" value="增加安检厅设备"/>
	</div>	
  </div>
</div>
