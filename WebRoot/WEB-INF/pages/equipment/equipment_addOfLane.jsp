  ...
  <fieldset>
    <div class="form-group">
      ...
      <div class="col-sm-8 col-md-6">
        <input class="form-control" id="equipment_id" name="id" type="text" placeholder="请输入设备编号"/>
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8 col-md-6">
        <input class="form-control" id="equipment_names" name="names" type="text" placeholder="请输入设备名称"/>
      </div>
      <div class="col-sm-1 col-md-4 lk-col-hidden"></div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-8 col-md-6">
        <input class="form-control" id="equipment_url" name="url" type="text" placeholder="请输入服务地址"/>
      </div>
      <div class="col-sm-1 col-md-4 lk-col-hidden"></div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-8 col-md-6">
        ...
        <%for(DictItem t : list){%>
          <option value="<%=t.getId()%>"><%=t.getOptions()%></option>
       	<%} %>
        </select>
      </div>
      <div class="col-sm-1 col-md-4 lk-col-hidden"></div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8 col-md-6">
        ...
        <%for(Lane t : laneList){%>
          <option value="<%=t.getId()%>"><%=t.getLaneName()%></option>
       	<%} %>
		</select>
      </div>
      <div class="col-sm-1 col-md-4 lk-col-hidden"></div>
    ...
    <div class="form-group">
      <label class="col-sm-3 col-md-2 control-label" for="equipment_url">备注</label>
      <div class="col-sm-8 col-md-6">
        <input class="form-control" id="equipment_url" name="remark" type="text" />
      </div>
      <div class="col-sm-1 col-md-4 lk-col-hidden"></div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-8 col-md-6">
        <input class="form-control" id="equipment_showway" name="showway" type="text" />
      </div>
      <div class="col-sm-1 col-md-4 lk-col-hidden"></div>
    </div>
    <div class="form-group">
