...
<head>
  ...
  <base href="<%=basePath%>"/>
  <%@ include file = "/js/include/index2.inc"%>
...
<body id="indexBody">
  ...
  <div id="header2">
    ...
    <div class="row" style="margin-top:-63px">
       <div class="col-lg-4 col-md-3 col-sm-3" style="min-height: 88px;"></div>
       <div class="col-lg-6 col-md-7 col-sm-7" style="min-height: 88px;">
        <div class="container-fluid">
          <div class="row" style="margin-bottom: 0px;">
            <div class="col-md-3 col-sm-3 Equipment">
			  <div class="" id="equipment_1">
			  	<div ></div>
				<div ></div>
			    <p class="position" id="equip1">前置卡口</p>
				<img src="images/index/Equipment_01.png">
			  </div>
            </div>  
            <div class="col-md-3 col-sm-3 Equipment">
			  <div class="" id="equipment_2">
			  	<div ></div>
				<div ></div>
                <p class="position" id="equip2">安检车道</p>
				<img src="images/index/Equipment_02.png">
			  </div>
            </div>
            
            <div class="col-md-3 col-sm-3 Equipment">
			  <div class="" id="equipment_3">
			  	<div ></div>
				<div ></div>
				<p class="position" id="equip3">数据门</p>
				<img src="images/index/Equipment_04.png">
			  </div>
            </div>
            
            <div class="col-md-3 col-sm-3 Equipment">
			  <div class="" id="equipment_4">
			  	<div ></div>
				<div ></div>
			    <p class="position" id="equip4">车底扫描</p>
    ...
    <div id="site" style="cursor: pointer;">
		...
		<div>
			<p>值班人员：${SESSION_BEAN.userView.names}</p>	<!-- &nbsp;&nbsp;&nbsp;&nbsp;联系方式： -->
		</div>
		<%} %>
	</div>
  </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-7 lk-panel">
		...
		<div class="li_height">
		  ...
		  <table class="carhis" >
		  	...
		  	<%for(int i=0;i<4;i++){%><tr <%if(i==1||i==3){%> class="gray" <%}%>>
          	  <%for(int j=0;j<7;j++){%>
      ...
      <div class="col-lg-5">
		<!-- 人员预警 -->
		<div class="lk-panel li_height" style="margin-top: 2px;">
		  <h3 class="grad">
		    <img class="title_icon" src="images/index/info.png">
    ...
    <div class="row" style="margin-top: 5px;">
      <div class="col-lg-7 lk-panel">
		...
		<table cellspacing="0" class="carhis" border="0" >
          ...
          <%for(int i=0;i<5;i++){%><tr <%if(i==0||i==2||i==4){%> class="gray" <%}%>>
          	<%for(int j=0;j<5;j++){%>
