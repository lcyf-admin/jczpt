...
<body id="indexBody">
  ...
  <div id="header">
    ...
    <img src="images/index/logo.png" style="top: 2px;position: absolute;left: 64px;" title="当前版本号：<%=BaseDataCode.version%>">
    ...
    <div id="site" style="cursor: pointer;">
		...
		<%}else{ %>
		<p><small>经度：${SESSION_BEAN.userView.x}&nbsp;&nbsp;纬度：${SESSION_BEAN.userView.y}</small>&nbsp;&nbsp;&nbsp;&nbsp;${SESSION_BEAN.userView.orgName}</p>
		<%} %>
	</div>
  </div>
  <!-- 主体 -->
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-lg-5">
		...
		<!-- 人员预警 -->
		<div class="lk-panel" style="margin-top: 5px;">
		  <h3 class="grad">
		    <img class="title_icon" src="images/index/info.png">
