...
<div style="margin: 10px 0 20px 0;border-bottom: 1px solid #ddd;height: 50px;">
	...
	<div style="text-align: center;font-size: 2em;color: #aaa;padding-top: 6px;">修改用户信息</div>
</div>
<form class="form-horizontal" role="form" id="form" action="">
  ...
  <fieldset>
    <div class="form-group">
      ...
      <div class="col-sm-4 ">
        <input class="form-control" type="text" value="${userView.account}" name="account" placeholder="请输入帐号" readonly="readonly" />
      </div>
      <label class="col-sm-1 control-label">组织机构</label>
      <div class="col-sm-4">
        <input readonly="readonly" class="form-control" value="${userView.orgName}" id="user_orgName" onclick="showMenu('user_orgName','orgzonZTree');" type="text" placeholder="请选择组织机构"/>
      	<input type="hidden" id="user_orgId" name="orgId" value="${userView.orgId}"/>
      </div>
      <div class="col-sm-1"></div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <input class="form-control" name="names" value="${userView.names}"  type="text" placeholder="请输入姓名"/>
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <input class="form-control" name="serials" value="${user.serials}" type="text" placeholder="请输入显示顺序"/>
      </div>
