...
<body style="border-radius:10px;padding: 0;	margin: 5px 15px 5px 5px;" >
<div>
  <h3 class="bg-info">车辆信息</h3>
  <div class="imgDivCar">
    <img height="250px" width="375px" src="${vehicle.carImg}" onerror="this.src='images/defautVehicle.jpg'" >
    <img height="250px" src="${vehicle.cardImg}" onerror="this.src='images/defaut.jpg'" style="max-width:375px;text-align: center; "/>
  </div>
