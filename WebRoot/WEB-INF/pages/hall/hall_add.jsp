   	...
   	function submitForm(){
	    ...
	    if (data) {
	        ...
	        if (!data.isValid()) {//无效
	        	...
	        	$.ajax({
		   			type:"POST",
		   			url:"hall_ajaxSave.do",
		   			async:false,
		   			data:$("#form").serialize(),
		   			success:function(data){
					    window.open("hall_list.do", "I3");
		   			}
		   		});
	        }
	    }
  ...
  <fieldset>
    <div class="form-group">
      ...
      <div class="col-sm-8 col-md-6">
		<input class="form-control" id="hall_hallName" name="hallName" type="text" placeholder="请输入安检厅名称"/>
      </div>
