...
<div style="margin: 10px 0 20px 0;border-bottom: 1px solid #ddd;height: 50px;">
	...
	<div style="text-align: center;font-size: 2em;color: #aaa;padding-top: 6px;">【${dict.names}】添加数据项</div>
</div>
<form class="form-horizontal" role="form" id="form" action="">
  ...
  <fieldset>
    <div class="form-group">
      ...
      <div class="col-sm-8 ">
        <input class="form-control" type="text" name="codes" placeholder="请输入选项代码"/>
      </div>
      <div class="col-sm-1"></div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-8 ">
        <input class="form-control" type="text" name="options" placeholder="请输入选项名称"/>
      </div>
      <div class="col-sm-1"></div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-8 ">
        <input class="form-control" type="text" name="ranking" placeholder="请输入选项顺序"/>
      </div>
      <div class="col-sm-1"></div>
    </div>
