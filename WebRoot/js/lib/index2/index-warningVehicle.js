	...
	function loadContrastVehicle(stationId){
		...
		$.ajax({
			type: "POST",
			url: "contrastVehicle_ajaxContrastVehicleList.action",
			...
			success: function(data){
				...
				for(var i=0;i<data.length;i++){
					...
					$("#warnVehicleList_"+i+"_2").text(data[i].idcardOmit);
					$("#warnVehicleList_"+i+"_3").text(data[i].passdateView);
					$("#warnVehicleList_"+i+"_4").text(data[i].actionOmit);
					$("#warnVehicleList_"+i+"_5").text(data[i].locationOmit);
					$("#warnVehicleList_"+i+"_6").text(data[i].isCheckedView);
				}
			},
	...
	function addContrastVehicle(data){
		for(var i=3;i>0;i--){
			...
			$("#warnVehicleList_"+i+"_5").text($("#warnVehicleList_"+(i-1)+"_5").text());
			$("#warnVehicleList_"+i+"_6").text($("#warnVehicleList_"+(i-1)+"_6").text());
		}
		...
		$("#warnVehicleList_0_2").text(data.idcardOmit);
		$("#warnVehicleList_0_3").text(data.passdateView);
		$("#warnVehicleList_0_4").text(data.actionOmit);
		$("#warnVehicleList_0_5").text(data.locationOmit);
		$("#warnVehicleList_0_6").text(data.isCheckedView);
