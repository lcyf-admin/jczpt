...
function winOpen(Url, Title) {
  ymPrompt.win({ message: Url, width: 500, height: 300, title: Title, maxBtn: false, minBtn: true, closeBtn: true,iframe: true })

}

//打开窗口
function winOpen700(Url, Title) {
  ymPrompt.win({ message: Url, width: 700, height: 400, title: Title, maxBtn: false, minBtn: true, iframe: true })

}

//打开窗口 无最大化 最小化 关闭
function winOpen700_x(Url, Title) {
  ymPrompt.win({ message: Url, width: 700, height: 400, title: Title, maxBtn: false, minBtn: false, iframe: true })

}

//打开窗口
function winOpen750(Url, Title) {
  ymPrompt.win({ message: Url, width: 750, height: 500, title: Title, maxBtn: false, minBtn: true, iframe: true })

}

//打开窗口
function winOpen750_(Url, Title) {
  ymPrompt.win({ message: Url, width: 750, height: 500, title: Title, maxBtn: false, minBtn: true, iframe: true })
...
//打开窗口
function winOpen390_(Url, Title) {
  ymPrompt.win({ message: Url, width: 500, height: 230, title: Title, maxBtn: false, minBtn: true, iframe: true })

}

//打开窗口
function winOpen391_(Url, Title) {
  ymPrompt.win({ message: Url, width: 700, height: 230, title: Title, maxBtn: false, minBtn: true, iframe: true })

}

//打开窗口
function winOpen590_(Url, Title) {
  ymPrompt.win({ message: Url, width: 600, height: 270, title: Title, maxBtn: true, minBtn: true, iframe: true })

}

//打开窗口
function winOpen751(Url, Title) {
  ymPrompt.win({ message: Url, width: 750, height: 450, title: Title, maxBtn: true, minBtn: true  })
...
function winOpenTXL(Url, Title) {
  ymPrompt.win({ message: Url, width: 750, height: 250, title: Title, maxBtn: true, minBtn: true, iframe: true })

}

//打开窗口
function winOpen752(Url, Title) {
  ymPrompt.win({ message: Url, width: 750, height: 500, title: Title, maxBtn: true, minBtn: true, iframe: true })

}


//打开窗口
function winOpen850(Url, Title) {
  ymPrompt.win({ message: Url, width: 800, height: 400, title: Title, maxBtn: true, minBtn: true, iframe: true })

}


function winOpen280(Url, Title) {
  ymPrompt.win({ message: Url, width: 280, height: 150, title: Title, maxBtn: false, minBtn: false, iframe: true })

}

function ymPromptclose() {
  //window.opener.location.href = window.opener.location.href;handler:ymPromptclose
...
//添加修改文别
function winOpenGWWB(Url, Title) {
  ymPrompt.win({ message: Url, width: 500, height: 300, title: Title, maxBtn: false, minBtn: false, iframe: true })

}


//添加修改文别
function winCommon(Url, Title,Width,Height) {
  ymPrompt.win({ message: Url, width: Width, height: Height, title: Title, maxBtn: false, minBtn: false, iframe: true })
